...
print(str2[:-1])        # This will return "samsun" because it slices from the beginning of the string to index -1 (exclusive).
print(str2[-1:])        # This will return "g" because it slices from index -1 to the end of the string.
...
print(str2[-1:5])       # This will return an empty string because the start index (-1) is greater than the stop index (5).
print(str2[2:-1])       # This will return "n" because it slices from index 2 to index -1 (exclusive).
print(str2[0:-1])       # This will return "samsung" because it slices from index 0 to index -1 (exclusive).
...
print(str2[-6:6])       # This will return "samsu" because it slices from index -6 to index 6 (exclusive).
